class Message
    ...
    #Text of all the stock messages
    ...
    UNKNOWN_USER_MESSAGE = "Sorry, I don't recognize your number. Sign up for The Nagging Machine at the-nagging-machine.herokuapp.com"
    ...
    INCORRECT_CONFIRMATION_CODE_MESSAGE = "That code is not recognized. Please refresh the page for a new code and try again. Confirmation codes become invalid after one hour." 
    WELCOME_MESSAGE = "Welcome to the Nagging Machine! Please enter the 4-digit code you see on your screen."
    UNCONFIRMED_PHONE_NUMBER_MESSAGE = "Your phone number is unconfirmed. Please visit the-nagging-machine.herokuapp.com, log in, and send the 4-digit code found on the screen."
